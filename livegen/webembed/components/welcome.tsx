    ...
    <div className="text-fg1 mx-auto flex min-h-screen max-w-prose flex-col justify-center py-4 md:py-20">
      <div className="h-[520px] space-y-10 px-4">
        <div className="items-top flex justify-between">
          <h1 className="text-fg0 text-2xl font-bold text-pretty">Alpha Proxima</h1>
          <div className="mt-1">
        ...
        <p>
          Alpha Proxima is an AI-powered customer service platform for
          business process outsourcing. Handle support, sales, and retention.
        </p>
